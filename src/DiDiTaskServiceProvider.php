...
namespace DiDiTask\Seat\SeatDiDiTask;

use Seat\Services\AbstractSeatPlugin;

class DiDiTaskServiceProvider extends AbstractSeatPlugin
{
    /**
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/resources/views', 'diditask');
    }
    ...
    public function register()
    {
        $this->mergeConfigFrom(
            __DIR__ . '/Config/diditask.sidebar.php', 'package.sidebar');

        $this->registerPermissions(
            __DIR__ . '/Config/Permissions/diditask.permissions.php', 'diditask');
    }
    ...
    {
        return 'https://github.com/GhostTraction/sg-diditask.git';
    }
